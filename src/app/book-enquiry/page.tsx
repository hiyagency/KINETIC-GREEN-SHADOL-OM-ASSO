    ...
    <section className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 lg:grid-cols-[0.8fr_1fr]">
      <div>
        ...
        <p className="mt-4 text-base leading-7 text-[#5c675f]">
          Enquire for no-licence EVs, no-RTO EVs, test rides, price details, finance details, availability, or final booking discussion. No online payment is collected.
        </p>
        <div className="mt-6 flex flex-wrap gap-3">
          <ButtonLink href={settings.whatsappUrl}>WhatsApp button</ButtonLink>
          <ButtonLink href={phoneHref(settings.phones[0])} variant="dark">Call button</ButtonLink>
        </div>
      </div>
