  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
      <div className="mb-8 max-w-4xl">
        ...
        <h1 className="mt-3 text-5xl font-black leading-tight text-[#101510]">Choose Your Electric Ride</h1>
        <p className="mt-4 text-base font-semibold leading-7 text-[#526057]">From student-friendly scooters to practical electric rides, explore vehicles available through Om Associate Shahdol. Call or WhatsApp to check today’s colours, stock, and latest price.</p>
      </div>
